    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-muted-foreground">
          Scan retail UPC or society barcodes. We match your catalog first, then look up title data from
          Open Library and Google Books so you can add new volumes in one step.
        </p>
      </div>
          ...
          <AlertDescription className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="secondary" asChild>
                <Link href={`/catalog?barcode=${encodeURIComponent(result.barcode)}`}>
                  Catalog filter
                </Link>
              </Button>
            </div>
